...
const Sidebar = () => {
  ...
  return (
    <div className="w-2/12 h-full shadow-2xl py-10"> 
      ...
      <nav className='w-4/5 h-full mx-auto mt-7 flex flex-col justify-between'>
         <ul className='flex flex-col gap-3'>
            <button className="bg-[#eb0d66] rounded px-5 py-2 md:px-2 py-2 text-white" onClick={displayCreate}> <span className='inline md:hidden'>+</span> <span className='hidden md:inline'>CREATE EVENT</span> </button>
